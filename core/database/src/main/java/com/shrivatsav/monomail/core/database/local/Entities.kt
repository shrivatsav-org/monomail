...
enum class PendingActionType {
    ...
    MESSAGE_TOGGLE_STAR, MESSAGE_ARCHIVE, MESSAGE_DELETE
}
...
fun Email.toEntity(accountId: String) = EmailEntity(
    ...
    inInbox = labels.contains("INBOX") && !labels.contains("TRASH"),
    inSent = labels.contains("SENT"),
    inArchived = !labels.contains("INBOX") && !labels.contains("TRASH") && !labels.contains("SENT") && !labels.contains("SPAM") && !labels.contains("DRAFT"),
